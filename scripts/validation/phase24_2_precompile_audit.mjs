...
check('No hay comando retirado y la columna SQLite histórica se conserva', !rust.includes('resolve_spotify_source') && rust.includes("ALTER TABLE playlist_items ADD COLUMN spotify_url TEXT NOT NULL DEFAULT ''"));
