...
const EXTRA_ES_TO_EN = Object.freeze({
  ...
  'Actualizaciones de Microsoft Store': 'Microsoft Store updates', 'Esta edición recibe sus actualizaciones a través de Microsoft Store.': 'This edition receives its updates through Microsoft Store.', 'Busca Clear Download Manager en la Biblioteca de Microsoft Store para instalar la versión más reciente.': 'Find Clear Download Manager in your Microsoft Store Library to install the latest version.',
  ...
  'Con tu consentimiento, yt-dlp lee el perfil local y puede enviar al sitio del contenido las cookies que correspondan. Al extraerlas, usa una copia temporal local.': 'With your permission, yt-dlp reads the local profile and may send matching cookies to the content site. It uses a temporary local copy while extracting them.',
  'Clear guarda la preferencia y, si eliges un archivo, su ruta local; no guarda los valores de las cookies en su base SQLite. Desactivar la opción no borra las cookies de Brave ni el archivo original.': 'Clear saves the preference and, if you choose a file, its local path; it does not save cookie values in its SQLite database. Turning this off does not delete Brave cookies or the original file.',
  'La preferencia de Brave se conserva y se aplica a análisis, descargas y playlists hasta que la desactives.': 'The Brave preference is saved and applied to analysis, downloads, and playlists until you turn it off.',
  ...
  'No se pudo guardar el archivo de cookies:': 'The cookies file could not be saved:',
  'Sesión multimedia guardada en Ajustes': 'Media session saved in Settings',
